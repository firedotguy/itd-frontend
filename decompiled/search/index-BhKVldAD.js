...
import { I as I_1 } from "./IconSearch-UKypaLoB.js";
const H = new a4(1, 300 * 1000 /* 1e3 */);
...
const I = {
  async getTrendingHashtags(c = 10) {
    ...
    const r = await a2.get(`${a3.hashtags.trending}?limit=${c}`);
    let t;
  ...
  async searchUsers(c, i = 20, r) {
    ...
    const n = await a2.get(`${a3.users.search}?${t.toString()}`);
    return {
  ...
  async globalSearch(c, i = 5, r = 5) {
    ...
    const n = await a2.get(`${a3.search.global}?${t.toString()}`);
    const o = n.data ?? n;
    return {
      users: o.users ?? [],
  ...
  async searchHashtags(c, i = 10) {
    ...
    const t = await a2.get(`${a3.hashtags.search}?${r.toString()}`);
    let n;
  ...
  return a3_1("div", {
    ...
    children: [
      a3_1("div", {
        ...
        children: a3_1("h1", { className: s.pageTitle, children: "Поиск" }),
      }),
      a3_1("div", {
