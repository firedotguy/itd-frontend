...
import { I } from "./IconCheck-DzRBFxf9.js";
import { I as I_1 } from "./IconNotificationMention-Cr8AcwM5.js";
const ne = "P3Nv664-";
const oe = "TjFPtUjO";
const se = "FVzwkwHP";
const re = "PUa4FZiJ";
...
const Y = {
  ...
  post_reaction: {
    badgeColor: "red",
    icon: u(G_1_1, { size: 12, filled: true }),
    getAction: (n) =>
      n > 1 ? `и ещё ${n - 1} человек оценили ваш пост` : "оценил(а) ваш пост",
  },
  post_comment: {
    badgeColor: "green",
    icon: u(J_1, { size: 12, filled: true }),
            ...
            children: [
              u("div", {
                ...
                children: [
                  ...
                  u("span", {
                    className: r.action,
                    children: B?.getAction($) || "уведомление",
                  }),
                ],
              }),
